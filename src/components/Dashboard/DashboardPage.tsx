...
const MainPage = () => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch('http://127.0.0.1:8000/insert_register', {
        method: 'POST',
        headers: {
        ...
        <div className="form-container">
          <div className="form-column">
            <form onSubmit={handleSubmit} className='form'>
              ...
              <input type="text" className="input-field" placeholder='MM-DD-YYYY' required value={fechaNacimiento} onChange={(e) => setFechaNacimiento(e.target.value)} />
